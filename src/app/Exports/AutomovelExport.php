...
class AutomovelExport implements FromQuery, WithHeadings, ShouldAutoSize,WithEvents, WithTitle
{
    /**
    ...
    */
    ...
    public function registerEvents(): array
    {
        return [
            ...
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->mergeCells(sprintf('A1:J1',$last_column));
                $event->sheet->mergeCells(sprintf('A2:J2',$last_column));
                $event->sheet->mergeCells(sprintf('A%d:J%d',$last_row,$last_row));
    
                // assign cell values
                $event->sheet->setCellValue('A1','LISTA DE AUTOMOVEIS');
    ...
    {
        return Automovel::query()->whereIn('id',$this->results);   
    }
}
