...
@section('titulo','Cadastrar Novo Automóvel')
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Erro ao cadastrar Automóvel.</h5>
        ...
        <div class="form-group">
            ...
            <div class="row mt-4">
                ...
                <div class="col-4">
                    ...
                    <input type="text"  class="form-control" maxlength="14" name="chassi" id="chassi" value="{{ old('chassi') }}">
                </div>
                <div class="col-4">
