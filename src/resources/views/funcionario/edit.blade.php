...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Erro ao Editar funcionário.</h5>
            ...
            <div class="row mt-4">
                <div class="col-4">
                    ...
                    <select name="sexo" class="form-control" id="sexo">
                        <option></option>
                        @if( isset($funcionario) && $funcionario->sexo == '1')
                ...
                <div class="col-4">
                        ...
                        <input type="password" data-js="password" class="form-control" name="password" id="password">
                </div>
            </div>
            <div class="row">
